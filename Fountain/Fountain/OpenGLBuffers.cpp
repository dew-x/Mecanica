...
*/
void OpenGLBuffers::sendDataToGPU(Vertex * data, int numVertices, int mode) {
	...
	if (mode == 1) glDrawArrays(GL_TRIANGLE_FAN, 0, numVertices);
	else if (mode == 2) glDrawArrays(GL_LINE_LOOP, 0, numVertices);
